...
"""三、將SqueezeNet模型,修改輸出層為7個類別並設置learning rate scheduler和Checkpoint做特徵提取"""
...
result_path = '../result/SqueezeNet/squeezenet'
...
# 假設特徵提取的最佳模型已經訓練完成並保存為 "suqeezenet_feature_extraction.pth"
