...
"""三、將MobileNetV2模型,修改輸出層為7個類別並設置learning rate scheduler和Checkpoint做特徵提取"""
...
result_path = '../result/MobileNetV2/mobilenetv2'
...
# 解凍 MobileNetV2 最後幾個卷積層進行微調
# 假設特徵提取的最佳模型已經訓練完成並保存為 "mobilenetv2_feature_extraction.pth"
